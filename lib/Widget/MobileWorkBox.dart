...
class MobileWork extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        WorkCustomData(
          title: "Senior Software Engineer | Upwork",
          subTitle:
              "I work as a senior software engineer on Upwork, freelancing in mobile app development. \nMy primary focus is on Flutter and React Native. I am also familiar with Swift and Kotlin.",
          duration: "Oct 2022 - Present",
        ),
        WorkCustomData(
          title: "Mobile Application Developer | Silvershere / Sentrics Ensure360",
          subTitle:
